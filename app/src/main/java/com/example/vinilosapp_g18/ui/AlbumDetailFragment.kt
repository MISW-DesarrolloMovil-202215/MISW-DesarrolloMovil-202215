...
import com.example.vinilosapp_g18.databinding.AlbumDetailFragmentBinding
import com.example.vinilosapp_g18.models.Album
import com.example.vinilosapp_g18.ui.adapters.AlbumDetailAdapter
import com.example.vinilosapp_g18.viewmodels.AlbumDetailViewModel
...
class AlbumDetailFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.album.observe(viewLifecycleOwner, Observer<List<Album>> {
            it.apply {
