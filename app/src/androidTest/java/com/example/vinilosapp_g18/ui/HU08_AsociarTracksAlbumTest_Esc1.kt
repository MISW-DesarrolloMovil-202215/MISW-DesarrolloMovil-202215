...
class HU08_AsociarTracksAlbumTest_Esc1 {
    ...
    @Test
    fun hU08_AsociarTracksAlbumTest_Esc1() {
        ...
        trackName.perform(replaceText(testTrack.nameTrack), closeSoftKeyboard())
        Thread.sleep(1500)
        ...
        val textViewh = onView(
            allOf(
                ...
                withText(containsString(testTrack.nameTrack)),
                withParent(withParent(IsInstanceOf.instanceOf(android.widget.LinearLayout::class.java))),
                isDisplayed()
            )
        )
